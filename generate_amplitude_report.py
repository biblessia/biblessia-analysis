...
# 데이터 정의 (Amplitude에서 가져온 데이터 - 2026-05-16 업데이트, 글로벌 오픈 - 한국 필터 제거)
WAU_DATA = {
    "dates": ["2025-11-24","2025-12-01","2025-12-08","2025-12-15","2025-12-22","2025-12-29","2026-01-05","2026-01-12","2026-01-19","2026-01-26","2026-02-02","2026-02-09","2026-02-16","2026-02-23","2026-03-02","2026-03-09","2026-03-16","2026-03-23","2026-03-30","2026-04-06","2026-04-13","2026-04-20","2026-04-27","2026-05-04"],
    "values": [1182,1119,1124,1110,1392,2088,2135,2077,2096,2191,2344,2297,2219,2467,2800,2982,2944,2993,3040,2988,3135,3027,3026,3065]
}

# WAU 지역별 분석 (한국 vs 한국 외) - 글로벌 오픈 후 추가
WAU_BY_REGION_DATA = {
    "dates": ["2025-11-24","2025-12-01","2025-12-08","2025-12-15","2025-12-22","2025-12-29","2026-01-05","2026-01-12","2026-01-19","2026-01-26","2026-02-02","2026-02-09","2026-02-16","2026-02-23","2026-03-02","2026-03-09","2026-03-16","2026-03-23","2026-03-30","2026-04-06","2026-04-13","2026-04-20","2026-04-27","2026-05-04"],
    "korea": [1152,1097,1095,1084,1348,2010,2075,2002,2030,2119,2273,2224,2140,2410,2726,2921,2888,2921,2975,2923,3068,2970,2965,2971],
    "non_korea": [33,27,37,33,60,105,87,105,120,110,121,120,117,89,95,76,86,95,89,88,91,84,91,119]
}

NAU_DATA = {
    "dates": ["2025-11-24","2025-12-01","2025-12-08","2025-12-15","2025-12-22","2025-12-29","2026-01-05","2026-01-12","2026-01-19","2026-01-26","2026-02-02","2026-02-09","2026-02-16","2026-02-23","2026-03-02","2026-03-09","2026-03-16","2026-03-23","2026-03-30","2026-04-06","2026-04-13","2026-04-20","2026-04-27","2026-05-04"],
    "values": [183,129,181,160,493,757,382,272,267,341,369,250,245,376,409,508,361,315,328,360,272,236,312,250]
}
...
RETENTION_DATA = [
    ...
    ["Global", "Overall", "Retained", 5199, 2841, 2164, 1878, 1585, 1363, 1160, 996, 863, 703, 551, 419, 339, 247, 150, 65, 55],
    ["Global", "Overall", "Retained %", "100.0%", "57.41%", "46.67%", "42.67%", "38.39%", "36.16%", "33.71%", "31.86%", "31.21%", "31.15%", "29.82%", "28.46%", "27.63%", "25.28%", "24.67%", "24.34%", "20.6%"],
    ["Global", "May 04, 2026", 250, 250, 141],
    ["Global", "Apr 27, 2026", 312, 312, 209, 158],
    ["Global", "Apr 20, 2026", 236, 236, 131, 115, 87],
    ["Global", "Apr 13, 2026", 272, 272, 158, 115, 123, 99],
    ["Global", "Apr 06, 2026", 360, 360, 231, 185, 165, 151, 123],
    ["Global", "Mar 30, 2026", 328, 328, 151, 142, 114, 109, 89, 76],
    ["Global", "Mar 23, 2026", 315, 315, 165, 135, 110, 101, 84, 78, 66],
    ["Global", "Mar 16, 2026", 361, 361, 202, 160, 134, 133, 130, 107, 99, 87],
    ["Global", "Mar 09, 2026", 508, 508, 285, 238, 226, 187, 179, 163, 148, 139, 117],
    ["Global", "Mar 02, 2026", 409, 409, 258, 211, 205, 179, 173, 146, 141, 131, 127, 100],
    ["Global", "Feb 23, 2026", 376, 376, 240, 186, 167, 161, 140, 127, 129, 119, 117, 105, 88],
    ["Global", "Feb 16, 2026", 245, 245, 136, 115, 105, 100, 105, 102, 92, 90, 82, 72, 71, 67],
    ["Global", "Feb 09, 2026", 250, 250, 141, 117, 129, 101, 100, 101, 90, 85, 91, 85, 76, 80, 73],
    ["Global", "Feb 02, 2026", 369, 369, 210, 172, 149, 147, 134, 122, 113, 111, 105, 106, 106, 96, 93, 85],
    ["Global", "Jan 26, 2026", 341, 341, 192, 149, 141, 121, 140, 122, 108, 107, 106, 100, 93, 95, 87, 87, 79],
    ["Global", "Jan 19, 2026", 267, 267, 132, 124, 110, 95, 89, 92, 76, 81, 75, 83, 73, 68, 67, 63, 65, 55],
]
